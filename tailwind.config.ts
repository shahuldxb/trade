module.exports = {
  ...
  plugins: [
    ...
    require('./client/src/plugins/plugin'),
    require('./client/src/plugins/components/theme'),
    require('./client/src/plugins/components/breakpoints'),
    require('./client/src/plugins/components/typography'),
    require('./client/src/plugins/components/menu'),
    require('./client/src/plugins/components/dropdown'),
    require('./client/src/plugins/components/accordion'),
    require('./client/src/plugins/components/input'),
    require('./client/src/plugins/components/input-group'),
    require('./client/src/plugins/components/select'),
    require('./client/src/plugins/components/textarea'),
    require('./client/src/plugins/components/file-input'),
    require('./client/src/plugins/components/switch'),
    require('./client/src/plugins/components/checkbox'),
    require('./client/src/plugins/components/radio'),
    require('./client/src/plugins/components/range'),
    require('./client/src/plugins/components/container'),
    require('./client/src/plugins/components/image-input'),
    require('./client/src/plugins/components/modal'),
    require('./client/src/plugins/components/drawer'),
    require('./client/src/plugins/components/tooltip'),
    require('./client/src/plugins/components/popover'),
    require('./client/src/plugins/components/btn'),
    require('./client/src/plugins/components/btn-group'),
    require('./client/src/plugins/components/tabs'),
    require('./client/src/plugins/components/pagination'),
    require('./client/src/plugins/components/card'),
    require('./client/src/plugins/components/table'),
    require('./client/src/plugins/components/badge'),
    require('./client/src/plugins/components/rating'),
    require('./client/src/plugins/components/scrollable'),
    require('./client/src/plugins/components/progress'),
    require('./client/src/plugins/components/apexcharts'),
    require('./client/src/plugins/components/leaflet')
  ]
};
