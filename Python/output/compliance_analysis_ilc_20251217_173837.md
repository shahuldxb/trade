...
| ilc.txt | Document 11.txt | Cartons per Pallet | 50 cartons per pallet | Pallet 7 has 49 cartons | Carton count discrepancy in packing list. |
...
Discrepancy Short Detail: Pallet 7 shows 49 cartons instead of the required 50 cartons per pallet.  
Discrepancy Long Detail: The packing list indicates that Pallet 7 contains 49 cartons, which does not align with the LC requirement of 50 cartons per pallet. This discrepancy could lead to non-compliance with the LC terms and potential rejection of the document set.  
Discrepancy Base Value vs Target Value:  
  - Base (Doc. Credit ilc.txt): Cartons per Pallet: 50 cartons per pallet  
  - Target (Document 11.txt): Cartons per Pallet: Pallet 7 has 49 cartons  
...
Impact: This discrepancy may result in delays or rejection of the shipment by the issuing bank, as it fails to meet the LC's stipulated packing requirements.  
---
#### Serial ID: 4  
...
Impact: This discrepancy could result in the issuing bank rejecting the document, delaying payment, and requiring amendments to align with LC terms.
---
#### Serial ID: 5  
Type: Quantity Discrepancy  
...
Golden Truth Value: 4,000.00 kg  
Secondary Document Value: 3,998.00 kg  
Impact: This discrepancy could result in delays or refusal of payment under the LC, as the issuing bank may consider the documents non-compliant.
---
#### Serial ID: 6  
...
Discrepancy Long Detail: The LC specifies Institute Cargo Clauses (C), while the submitted document indicates Institute Cargo Clauses (A). This mismatch could lead to non-compliance with LC terms, potentially resulting in rejection of the document.  
Discrepancy Base Value vs Target Value:  
...
Impact: This discrepancy may result in the issuing bank rejecting the document due to non-compliance with the LC's stipulated insurance requirements.
---
#### Serial ID: 7  
...
Discrepancy Long Detail: The LC specifies Vietnam as the claims payable location, while the insurance certificate lists Dubai, United Arab Emirates. This discrepancy may lead to non-compliance with LC terms and potential rejection of documents by the issuing bank.  
Discrepancy Base Value vs Target Value:  
...
Impact: This discrepancy could result in the issuing bank refusing payment due to non-conformance with LC terms, causing delays or financial loss.  
---
#### Serial ID: 8  
...
Discrepancy Long Detail: The bill of lading indicates a shipment date of 26-Sep-2025, which is one day later than the latest shipment date of 25-Sep-2025 specified in the LC. This discrepancy may lead to non-compliance with the LC terms and potential rejection of the documents by the issuing bank.  
Discrepancy Base Value vs Target Value:  
  ...
  - Difference: The shipment date in the bill of lading is one day later than the LC's latest allowed shipment date.  
Severity Level: Medium  
...
Discrepancy Long Detail: The base document specifies "Cat Lai Terminal, Ho Chi Minh City, Vietnam" as the port of discharge, while the target document lists only "Ho Chi Minh City, Vietnam." This mismatch may lead to confusion or rejection due to non-compliance with LC terms.  
Discrepancy Base Value vs Target Value:  
  ...
  - Difference: Specific terminal name "Cat Lai Terminal" is missing in the target document.  
Severity Level: Medium  
Golden Truth Value: Cat Lai Terminal, Ho Chi Minh City, Vietnam  
Secondary Document Value: Ho Chi Minh City, Vietnam  
Impact: The discrepancy may result in rejection of the bill of lading by the issuing bank, causing delays or financial loss.
---
#### Serial ID: 10  
Type: Goods Description Discrepancy  
...
Impact: This mismatch may result in the issuing bank refusing the document due to non-compliance, delaying payment or shipment processing.
---
#### Serial ID: 11  
