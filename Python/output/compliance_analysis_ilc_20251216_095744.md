...
| ilc.txt | Document 8.txt | Cartons per Pallet | 50 pieces per carton | Pallet 7 = 49 cartons | Carton count discrepancy for Pallet 7. |
---
...
Impact: This discrepancy may result in the issuing bank rejecting the documents due to non-compliance with the LC terms, delaying payment or shipment processing.  
---
#### Serial ID: 2  
...
Discrepancy Long Detail: The net weight specified in the Letter of Credit (4,000.00 kg) does not match the net weight in the secondary document (3,998.00 kg). This discrepancy could lead to non-compliance with the LC terms and potential rejection of the documents by the issuing bank.  
Discrepancy Base Value vs Target Value:  
...
Impact: This discrepancy may result in delays or rejection of the documents, potentially affecting payment under the LC terms.
---
#### Serial ID: 3  
Type: Remarks Discrepancy  
Discrepancy ID: RM-003  
Discrepancy Title: Extra Information in Remarks Field  
Discrepancy Short Detail: Remarks field in the target document contains additional information not specified in the base document.  
Discrepancy Long Detail: The base document does not specify any remarks, while the target document includes additional information regarding banking charges outside UAE for the applicant. This discrepancy could lead to compliance issues as it introduces terms not agreed upon in the original LC.  
Discrepancy Base Value vs Target Value:  
...
Discrepancy Short Detail: Buyer specification in the LC differs from the secondary document.  
Discrepancy Long Detail: The buyer specification in the LC (Base Document) does not match the revised version in the secondary document. This discrepancy may lead to compliance issues and potential rejection of the document by the issuing bank.  
Discrepancy Base Value vs Target Value:  
  - Base (Doc. Credit ilc.txt): Buyer Specification: VGE/KT-2025-09  
  - Target (Document 2.txt): Buyer Specification: VGE/KT-2025-09 (Rev A)  
  - Difference: The base document specifies "VGE/KT-2025-09," while the target document includes an additional revision indicator "(Rev A)."  
Severity Level: Medium  
Golden Truth Value: VGE/KT-2025-09  
Secondary Document Value: VGE/KT-2025-09 (Rev A)  
Impact: This mismatch could result in the issuing bank refusing the document due to non-compliance with the LC terms, causing delays or financial loss.  
---
#### Serial ID: 5  
...
Discrepancy Long Detail: The base document specifies Institute Cargo Clauses (C), while the target document lists Institute Cargo Clauses (A). This difference impacts the scope of insurance coverage, potentially leading to non-compliance with LC terms and rejection risk.  
Discrepancy Base Value vs Target Value:  
  ...
  - Difference: Institute Cargo Clauses (C) in the base document is replaced with Institute Cargo Clauses (A) in the target document, altering the coverage scope.  
Severity Level: Medium  
...
Impact: The mismatch may lead to rejection of the document by the issuing bank due to non-compliance with LC terms, exposing the transaction to financial and operational risks.  
---
#### Serial ID: 6  
...
Discrepancy Long Detail: The location for claims payable is stated as Vietnam in the LC (ilc.txt) but as Dubai, United Arab Emirates in Document 3.txt. This mismatch could lead to confusion or disputes regarding the jurisdiction for claims settlement, potentially impacting compliance with the LC terms.  
Discrepancy Base Value vs Target Value:  
  - Base (Doc. Credit ilc.txt): Claims Payable: Vietnam  
  - Target (Document 3.txt): Claims Payable: Dubai, United Arab Emirates  
  - Difference: The specified claims payable location does not match between the documents.  
Severity Level: Medium  
Golden Truth Value: Vietnam  
Secondary Document Value: Dubai, United Arab Emirates  
Impact: This discrepancy may result in rejection of the document set by the issuing bank due to non-compliance with the LC terms.
---
#### Serial ID: 7  
Type: Shipment Date Discrepancy  
Discrepancy ID: SD-007  
Discrepancy Title: Shipped on Board Date Exceeds Latest Shipment Date  
Discrepancy Short Detail: Shipped on board date in Document 6.txt exceeds the LC's latest shipment date.  
Discrepancy Long Detail: The shipped on board date in the secondary document (26-Sep-2025) is later than the latest shipment date specified in the LC (25-Sep-2025). This discrepancy violates the shipment timeline stipulated in the LC, potentially leading to non-compliance with the credit terms.  
Discrepancy Base Value vs Target Value:  
...
Discrepancy Base Value vs Target Value:  
  ...
  - Difference: A shortfall of 2.00 kg in the net weight stated in Document 6 compared to the LC.  
Severity Level: Medium  
Golden Truth Value: 4,000.00 kg  
Secondary Document Value: 3,998.00 kg  
...
Impact: The discrepancy could result in payment delays or refusal by the issuing bank, as accurate weight is critical for compliance with LC terms.
---
#### Serial ID: 10  
Type: Quantity Discrepancy  
Discrepancy ID: QT-010  
Discrepancy Title: Net Weight Mismatch Between LC and Document 8  
Discrepancy Short Detail: Net weight in LC and Document 8 differs by 2.00 kg.  
...
Discrepancy Long Detail: The LC specifies 50 pieces per carton, but Document 8 indicates Pallet 7 contains only 49 cartons. This discrepancy may lead to non-compliance with LC terms and potential rejection of the document.  
Discrepancy Base Value vs Target Value:  
...
Impact: This discrepancy could result in delays or rejection of the shipment by the issuing bank, affecting payment and delivery timelines.  
