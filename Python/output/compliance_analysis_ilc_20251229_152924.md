...
| Letter of Credit (LC) | Insurance Certificate (Document 13.txt) | Coverage | Institute Cargo Clauses (C) | Institute Cargo Clauses (A) | Coverage clause discrepancy. |
...
Discrepancy Short Detail: Coverage clause differs between LC and Insurance Certificate.  
...
Discrepancy Base Value vs Target Value:  
  ...
  - Difference: Coverage type specified in the LC does not align with the coverage type in the Insurance Certificate.  
Severity Level: Medium  
Golden Truth Value: Institute Cargo Clauses (C)  
Secondary Document Value: Institute Cargo Clauses (A)  
Impact: The discrepancy may result in refusal of the Insurance Certificate by the issuing bank, potentially delaying the transaction and increasing compliance risks.  
---
#### Serial ID: 5  
...
Discrepancy Long Detail: The Letter of Credit specifies the sum insured as USD 141,295.00 (110% of invoice value), while the insurance certificate lists AED 471,000.00. This discrepancy in both currency and insured amount may lead to non-compliance with LC terms, risking rejection of the document.  
Discrepancy Base Value vs Target Value:  
  ...
  - Difference: Currency mismatch (USD vs AED) and sum insured value discrepancy.  
Severity Level: High  
...
Discrepancy Long Detail: The Letter of Credit specifies a net weight of 4,000.00 kg, while the Commercial Invoice indicates 3,998.00 kg. This discrepancy may lead to non-compliance with LC terms and potential rejection by the issuing bank.  
Discrepancy Base Value vs Target Value:  
  - Base (Doc. Credit ilc.txt): Net Weight: 4,000.00 kg  
...
Discrepancy Long Detail: The Buyer Specification in the Quality Certificate includes a revision ("Rev A") not present in the Letter of Credit. This discrepancy may indicate an unapproved or unauthorized change, potentially leading to non-compliance with LC terms.  
Discrepancy Base Value vs Target Value:  
...
Impact: This discrepancy may result in rejection of the Quality Certificate by the issuing bank, delaying payment or shipment acceptance.
